...
int main()
{
	...
	//displays the result
	cout<<"Largest element: "<<largest(a,n)<<endl;
	cout<<"Smallest element: "<<smallest(a,n)<<endl;
	cout<<"Most frequent element: "<<mode(a,n)<<endl;
        cout<<"Mean of the elements: "<<mean(a,n)<<endl;
        cout<<"Median of the elements: "<<median(a,n)<<endl;
	//closing the program
	return 0;
}
